...
export function App() {
  ...
  function handleFlavourChange(buttonFlavor) {
    setFlavour(buttonFlavor);
  }
  return (
    <div className={"bg-amber-300 h-screen w-screen text-black text-center"}>
      ...
      <AppButton onClick={() => setCupOrCone("cup")}>ספל</AppButton>
      <AppButton onClick={() => setCupOrCone("cone")}>גביע</AppButton>
